...
## Single Responsability Principle - *Principio de responsabilidad única* {#srp .smaller} 


{{< fa check >}} Una clase debería tener **un único propósito**: Reduce complejidad, fácil entender qué hace cada clase

. . .

{{< fa check >}} Una clase debería tener una **(buena) razón para cambiar**: Si hace demasiadas tareas, hay que modificarla cada vez que una de esas tareas cambia.
