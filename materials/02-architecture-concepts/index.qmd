...
:arrow_right: Estilo(s) de la arquitectura, i.e., organización lógica de las partes (por capas, microservicios, etc.)
...
:arrow_right: Criterios y/o requisitos para el funcionamiento correcto del sistema (ortogonal a la funcionalidad)
...
:arrow_right: Reglas y/o restricciones (tajantes) del sistema, i.e. qué se puede y no se puede hacer
...
:arrow_right: Guías, recomendaciones o preferencias (en contraposición a las *reglas tajantes* como las decisiones)
